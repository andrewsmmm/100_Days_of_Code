...
if choice_1 == "left":
    ...
    if choice_2 == "ferryman":
        ...
        print("You walk on a little further and come to an old cottage with three "
              "coloured doors. One red, one yellow and one blue. "
    ...
    if choice_4 == "climb":
        ...
        choice_5 = input("One red, one yellow and one blue. Which door do you choose? "
                         "Enter red, yellow or white: ")
        if choice_5 == "red":
            print("You are engulfed in fire. GAME OVER!")
